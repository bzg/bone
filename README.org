...
script using [[https://github.com/junegunn/fzf][fzf]] for browsing [[https://codeberg.org/bzg/bark][BARK]] reports.
...
| =~/.config/bone/cache/=         | Cached patches            |
| =~/.config/bone/reports-cache/= | Cached reports.json files |
