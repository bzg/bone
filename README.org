...
- Send a [[mailto:~bzg/barkyard@lists.sr.ht?subject=\[BUG\] bone: <SHORT EXPLICIT BUG DESCRIPTION>][bug report]]
- Send a [[mailto:~bzg/barkyard@lists.sr.ht?subject=\[PATCH\] bone: <COMMIT SUMMARY>][patch]] (please use =git format-patch=)
- Send a [[mailto:~bzg/barkyard@lists.sr.ht?subject=\[FR\] bone: <FEATURE REQUEST>][feature request]]
- Share any [[mailto:~bzg/barkyard@lists.sr.ht?subject=bone: <ANYTHING>][other question or idea]]
